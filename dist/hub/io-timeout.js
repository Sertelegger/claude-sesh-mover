 ...
 */
export function hubIoTimeoutMs() {
    const raw = process.env.SESH_MOVER_HUB_IO_TIMEOUT_MS;
    if (raw === undefined || raw === "")
        return HUB_IO_TIMEOUT_MS;
...
export class HubIoTimeoutError extends Error {
    ...
    constructor(op, timeoutMs) {
        super(`the hub did not answer a ${op} within ${timeoutMs}ms — the configured hub.path looks like a mount that has stopped responding`);
 ...
 */
export function hubIoAbandoned() {
 ...
 */
export async function withHubIoTimeout(op, run, dispose) {
...
//# sourceMappingURL=io-timeout.js.map