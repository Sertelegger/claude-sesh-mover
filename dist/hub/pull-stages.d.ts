 ...
 */
export declare function stageSkip<T>(reasons: string | string[], value?: T | null): StageOutcome<T>;
 ...
 */
export declare function stageAbort<T>(terminal: ErrorResult): StageOutcome<T>;
