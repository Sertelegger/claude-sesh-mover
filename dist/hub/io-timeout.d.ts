 ...
 * `LOCK_STALE_MS` is.
 */
export declare const HUB_IO_TIMEOUT_MS = 30000;
/**
 ...
 */
export declare function hubIoTimeoutMs(): number;
/**
 ...
 */
export declare class HubIoTimeoutError extends Error {
    readonly op: string;
 ...
 */
export declare function hubIoAbandoned(): boolean;
/**
 ...
 */
export declare function withHubIoTimeout<T>(op: string, run: () => Promise<T>, dispose?: (value: T) => void): Promise<T>;
//# sourceMappingURL=io-timeout.d.ts.map