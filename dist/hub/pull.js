...
import { foreignKeyedRecord, readSyncState, writeSyncState, recordSentToPeer, } from "../sync-state.js";
/**
 ...
 */
export function reportPullResult(report, warnings) {
    return {
        success: true,
        command: "pull",
...
export async function hubPull(opts) {
    ...
    try {
        ...
        if (sel.kind === "report")
            return reportPullResult(sel.value, warnings);
