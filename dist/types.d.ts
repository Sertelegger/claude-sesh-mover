...
export type CliResult = ExportResult | ExportPayloadPlanResult | ImportResult | DryRunResult | MigrateResult | BrowseResult | ConfigureResult | HubInitResult | HubStatusResult | HubPushResult | HubPushFailedResult | WhereisResult | HubUnlinkedResult | HubNoSuchProjectResult | HubUnreachableResult | HubUnlinkResult | HubLockBusyResult | HubProjectRetiredResult | HubRetireResult | HubDeleteResult | HubRetireFailedResult | HubPullResult | HubPullListResult | NotYetSyncedResult | HubReindexResult | HubReindexFailedResult | HubRekeyResult | HubRekeyRefusedResult | HubEncryptResult | HubEncryptRefusedResult | HubEscrowResult | HubEscrowRefusedResult | HubEncryptionRefusedResult | ErrorResult;
/**
