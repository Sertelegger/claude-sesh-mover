...
export interface HubRekeyResult {
   ...
   * compaction, not here.
   */
  skipped: Array<{ file: string; reason: "plaintext" }>;
  /**
   ...
   */
  failed: Array<{ file: string; reason: BundleFetchFailureKind; message: string }>;
  /**
   ...
   * run this again.
   */
  narrowed: Array<{ file: string; before: number; after: number }>;
