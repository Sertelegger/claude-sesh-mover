...
export function compactionDirPath(projectId: string): string {
 ...
 */
export function compactionPath(projectId: string, machineId: string): string {
  assertSafeHubId(machineId, "machineId");
 ...
 */
export function workspaceDir(projectId: string, machineId: string): string {
  assertSafeHubId(machineId, "machineId");
 ...
 */
export function isEncryptedBundleFile(fileOrPath: string): boolean {
