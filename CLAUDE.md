...
These facts were verified against the installed Claude Code build's own embedded schema (2.1.221) and re-verified end-to-end in a real session. They are not guesses — check them again before changing this file:
